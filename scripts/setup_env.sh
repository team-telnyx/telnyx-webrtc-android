...
sed -i '' 's/<SIP_USER>/'"$user"'/g' sdk/src/test/java/com/telnyx/webrtc/sdk/testhelpers/TestConstants.kt
sed -i '' 's/<SIP_PASSWORD>/'"$password"'/g' sdk/src/test/java/com/telnyx/webrtc/sdk/testhelpers/TestConstants.kt
